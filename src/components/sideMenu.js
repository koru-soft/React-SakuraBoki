...
const TaxGrade3 = () => {
    return (
		...
		<div className="explanation-wrapper">
			...
			<br />
			<div>②勘定科目の割当</div>
			<div>最終的に発生したもの（借方）：税込経理となるため、仕入代金と消費税額の合計額で金額を計上します。よって、仕入の費用は仕入にて税込み金額で処理</div>
			<div>なぜ発生したか（貸方）：現金での支払いとなるため、現金で処理</div>
			<br />
			<div>③勘定科目の配置</div>
			<div>最終的に発生したもの（借方）：仕入という費用が増加するので、借方に仕入を配置</div>
		...
		<div className="explanation-wrapper">
			...
			<br />
			<div>②勘定科目の割当</div>
			<div>最終的に発生したもの（借方）：税抜経理となるため、仕入代金と消費税額は区別して金額を計上します。よって、仕入の費用は税抜き金額で計上し、消費税額は仮払消費税で計上します</div>
			<div>なぜ発生したか（貸方）：</div>
			<br />
			<div>③勘定科目の配置</div>
