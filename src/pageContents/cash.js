...
　　　　　　　<div>株式とは？</div>
	...
	<section>
		...
		<div>収益や費用を適正に算定するため、期首において前期末の決算整理仕訳の逆仕訳を行う場合があります。これを再振替仕訳といいます。</div></div>
		<div></div>
		<div></div>
            <div></div>
            </article>
	...
	<Title title="割引とは"/>
		...
		<div>例題では支払った消費税（仮払消費税）よりも受け取った消費税（仮受消費税）の方が大きいので、両者の差額を後で納付することになります。そこで決算において仮払消費税と仮受消費税とを相殺し、その差額を未払消費税勘定（負債）に振り替えます。
		...
		<div>郵便局で切手￥100とハガキ￥200、収入印紙￥500を現金で購入した。
