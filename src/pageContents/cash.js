...
商品を売買するときに約束手形を振り出したときは支払手形勘定・受取手形勘定を使って処理しますが、これとは区別するように注意してください。
        ...
        <section>
            <article>
            <div>約束手形にせよ為替手形にせよ、受け取った手形は、期日まで待って支払人からお金をもらうこともできますが、期日前に仕入代金の支払いに用いることも出来ます。これを手形の裏書といいます。</div>
            <div>手形の裏書譲渡、割引、更改
...
不渡手形	103,000	当座預金	103,000
        ...
        <section>
            <article>
            <div>受け取った手形は、銀行に持っていって、現金に換えてもらうことも出来ます。これを手形の割引と言います。</div>
            <div>手形を割り引く際、手形売却損という手数料が発生するところが特徴になります。</div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>【営業外手形】商品以外のものを手形で売却（購入）した場合
...
また、商品以外のものを後払いで買った場合は未払金勘定で処理します。「未払金」は将来お金を払わなければならないという義務なので負債となります。</div>
            <div></div>
            </article>
        </section>
...
また、商品を引き渡す前にその代金を受け取った場合は前受金（まえうけきん）勘定で処理します。前受金勘定は将来商品を引き渡さなければならないという義務なので負債となります。</div>
            <div></div>
            </article>
        </section>
...
前払費用は一定の契約に従い、継続して役務（サービスなど）の提供を受ける場合、いまだ提供されていない役務に対し支払われた対価をいいます。前払費用は、このような役務提供契約以外の契約等による前払金とは区別しなければなりません</div>
            <div></div>
            </article>
        </section>
...
仕訳上は「未収利息」「未収家賃」などの具体的な名称を使いますが、貸借対照表に表示する場合は、すべてまとめて「未収収益」とします（ただし問題によっては仕訳上の科目を使う場合もあります）。</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>【立替金と預り金】源泉所得税や社会保険料などの処理方法
...
当座預金口座へ振り込まれた時点では内容が不明なので、どの勘定科目で処理すべきかわかりません。そこで、この金額を一時的に仮受金勘定（負債）で処理しておきます。</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            ...
            <div></div>
            <div>受取商品券とは？
商品の代金を信販会社などが発行した商品券で受け取った場合は受取商品券勘定で処理します。受取商品券はあとで信販会社などに代金を請求できる権利なので資産です。</div>
            </article>
        </section>
