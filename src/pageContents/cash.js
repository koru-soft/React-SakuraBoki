...
　　　　　　有形固定資産（例.建物、土地など）
	　↗
固定資産 →　無形固定資産（例.商標権、特許権、のれんなど）
　　　　↘️
　　　　　　投資その他の資産


＜固定資産の会計処理＞
固定資産の購入は、資産の計上になるので費用にならない
→耐用年数（Service Life）に応じて、価値の減少に伴い一定額を費用化する</div>
            <div>有形固定資産（ゆうけいこていしさん）とは、営業活動のために長期間にわたって使用するために保有する有形の資産のことをいいます。
...
固定資産台帳
事業主が保有している固定資産を管理するために作成する帳簿。</div>
            </article>
        </section>
        ...
        <section>
            ...
            <table border="1" cellspacing="0" class="journal">
                <caption class="question">売買目的で株式を100,000円購入した。</caption>
                <tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
