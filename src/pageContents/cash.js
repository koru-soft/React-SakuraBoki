...
　　　　　　　<div>株式とは？</div>
	    ...
	    <div>有価証券の分類</div>
		<div>有価証券はその保有目的に応じて大きく５つに分類して処理・表示します。</div>
		
		<table border="1" cellspacing="0" class="journal">
                <caption class="question">有価証券の分類</caption>
                <tr>
			<th>有価証券の名前</th>
			<th>保有目的</th>
			<th>表示科目（財務諸表に記載するときに使用する科目）</th>
			<th>貸借対照表価額（貸借対照表に記載される金額）</th>
                </tr>
                <tr>
			<td>売買目的有価証券</td>
			<td>短期間の価格変動により利益を得ることを目的として保有。</td>
			<td>「有価証券」（流動資産）</td>
			<td>時価をもって貸借対照表価額とし、評価差額は当期の損益（営業外損益）とする。</td>
                </tr>
		<tr>
			<td>満期保有目的債券</td>
			<td>利息の受け取りなどを目的として、満期まで所有する意図をもって保有。</td>
			<td>「投資有価証券」（固定資産（投資その他の資産））</td>
			<td>原則：取得原価　容認：償却原価法による価額</td>
                </tr>
		<tr>
			<td>子会社株式</td>
			<td>他の会社への支配力を行使するために保有。</td>
			<td>「関係会社株式」（固定資産（投資その他の資産））</td>
			<td>取得原価をもって貸借対照表価額とする。</td>
                </tr>
		<tr>
			<td>関連会社株式</td>
			<td>他の会社への影響力を行使するために保有。</td>
			<td>「関係会社株式」（固定資産（投資その他の資産））</td>
			<td>取得原価をもって貸借対照表価額とする。</td>
                </tr>
		<tr>
			<td>その他有価証券</td>
			<td>他社との業務提携や株式の相互持合いなどを目的として保有（上記４つ以外のもの）。</td>
			<td>「投資有価証券」（固定資産（投資その他の資産））</td>
			<td>貸借対照表価額は時価をもって貸借対照表価額とし、評価差額は貸借対照表（純資産の部）に記載。</td>
                </tr>
            </table>
	</article>
        </section>
	...
	<Title title="洗替法と切放法の会計処理"/>
        <section>
            <article>
            	<div>翌期首の処理（洗替法）</div>
		<div>その他有価証券の評価差額は翌期首において振り戻し処理を行います。このような方法を洗替法（あらいがえほう）といいます。</div>
		<div>例題2①のケース</div>
		<div>決算時の仕訳</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券	1,000	その他有価証券評価差額金	1,000</div>
		<div>翌期首の仕訳</div>
		<div>前期末に計上した評価差額を振り戻し、翌期首の帳簿価額を取得原価に戻してやります。やり方は前期末の逆仕訳をすればいいだけです。</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券評価差額金	1,000	その他有価証券	1,000</div>
		<div>洗替法では翌期首に振り戻しの仕訳を行うことによって、取得原価が翌期首の帳簿価額となります。なお、その他有価証券評価差額金はプラマイゼロとなって消去されます。</div>
		<div>例題2②のケース</div>
		<div>決算時の仕訳</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券評価差額金	500	その他有価証券	500</div>
		<div>翌期首の仕訳</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券	500	その他有価証券評価差額金	500</div>

		<div>【参考】前期に取得した売買目的有価証券の売却～洗替法VS切放法～</div>

		<div>洗替法とは？</div>
		<div>洗替法（あらいがえほう）とは、決算において時価に評価替えした後、翌期首に再振替仕訳を行って帳簿価額を取得原価に戻す方法をいいます。</div>

		<div>切放法とは？</div>
		<div>切放法（きりはなしほう）とは、決算において時価に評価替えした後、翌期首に再振替仕訳は行わず期末時価を翌期の帳簿価額とする方法をいいます。</div>

		<div>洗替法による処理方法</div>
		<div>例題1</div>
		<div>当社は、売買目的でA社株式（取得原価￥10,000）を保有している。以下の仕訳を答えなさい。なお、売買目的有価証券の評価差額の処理方法として洗替法を採用している。</div>

		<div>①決算時の仕訳（期末時価￥12,000）</div>

		<div>②翌期首の仕訳</div>

		<div>③翌期に￥13,000で売却したときの仕訳</div>

		<div>①決算時の仕訳</div>
		<div>決算において、帳簿価額（取得原価）を時価に評価替えします。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>売買目的有価証券	2,000	有価証券評価益	2,000</div>
		<div>②翌期首の仕訳</div>
		<div>洗替法では、翌期首において帳簿価額を取得原価に振り戻す処理を行います。前期末の逆仕訳です。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>有価証券評価益	2,000	売買目的有価証券	2,000</div>
		<div>③売却時の仕訳</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>現金など	13,000	売買目的有価証券	10,000</div>
		<div>有価証券売却益	3,000</div>

		<div>洗替法では期首において帳簿価額を取得原価に振り戻す処理をします。そのため、売却額と比較される帳簿価額は取得原価となります。</div>

		<div>切放法による処理方法</div>
		<div>例題2</div>
		<div>当社は、売買目的でA社株式（取得原価￥10,000）を保有している。以下の仕訳を答えなさい。なお、売買目的有価証券の評価差額の処理方法として切放法を採用している。</div>
		...
		<div>①決算時の仕訳</div>
		<div>決算において、帳簿価額（取得原価）を時価に評価替えします。これは洗替法と同じです。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>売買目的有価証券	2,000	有価証券評価益	2,000</div>
		<div>②翌期首の仕訳</div>
		<div>切放法では、翌期首において帳簿価額を取得原価に振り戻す処理は行いません。したがって、翌期首においては仕訳なしとなります。</div>

		<div>③売却時の仕訳</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>現金など	13,000	売買目的有価証券	12,000</div>
		<div>有価証券売却益	1,000</div>

		<div>切放法では期首において再振替仕訳はしないので、帳簿価額は前期末の時価のままとなります。そのため、売却額と比較される帳簿価額は前期末の時価となります。</div>

		<div>洗替法VS切放法</div>
		<div>有価証券評価益も有価証券売却益も、資金を売買目的有価証券で運用することによって得られる財務活動の成果といえます。したがって、これらをまとめて有価証券運用益と捉えることができます。</div>
		<div>洗替法の場合、売買目的有価証券の運用によって得られ儲けは￥1,000となります。一方、切放法の場合も儲けは￥1,000となり、洗替法でも切放法でも有価証券運用益は同じです。</div>
		<div>要するに、評価損益か売却損益かという内訳が異なるだけで、「運用によって得られる儲け」という大きな視点で見た場合はどちらの方法でも同じになるので問題ないというわけです。</div>
		<div>社債等を利払日以外に売買した場合～端数利息の計算方法と仕訳のやり方～</div>
		<div>社債についている利札（クーポン）を利払日に金融機関に持ち込めば利息を受け取ることができます。つまり、利息を受け取ることができるのは利払日に社債を保有している者ということになるわけです。もし利払日の1日前に社債を売却した場合、1円も利息を受け取ることができないのでしょうか？</div>
            <div></div>
            </article>
        </section>

	<Title title="その他有価証券の会計処理"/>
        <section>
            <article>
            <div>その他有価証券とは、売買目的有価証券、満期保有目的の債券、子会社株式および関連会社株式以外の有価証券をいいます。</div>
		<div>その他有価証券を購入したときは購入代価に付随費用を加えた金額を取得原価とし、その他有価証券勘定で処理します。</div>
		<div>業務提携を目的として、A社株式を￥10,000で購入し、代金は現金で支払った。</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券	10,000	現金	10,000</div>
		<div>決算時の処理（時価評価）</div>
		<div>売買目的有価証券、満期保有目的の債券、子会社株式および関連会社株式以外の有価証券はすべて「その他有価証券」に分類されるため、その保有目的は多岐にわたり、保有目的ごとに評価することは困難です。</div>
		<div>一方で、財務諸表の利用者にとって有用な情報は有価証券の期末時点の時価にあります。そのため、その他有価証券は時価で評価するということになっています。</div>
		<div>したがって、決算時には帳簿価額を時価に評価替えする処理が必要になります。</div>
		<div>また、評価差額はすべて「その他有価証券評価差額金」として処理し、貸借対照表の純資産の部（評価・換算差額等の区分）に表示します。ちなみに、この方法を全部純資産直入法といいます。</div>
		<div>全部純資産直入法のほかに部分純資産直入法という方法もありますが1級の範囲なのでここでは説明しません。</div>
		<div>当社はA社株式（取得原価￥10,000）をその他有価証券として保有している。次の各ケースにおける有価証券の期末評価（全部純資産直入法）に関する仕訳を答えなさい。</div>
		<div>①期末時価が￥11,000の場合</div>
		<div>②期末時価が￥9,500の場合</div>
		<div>①期末時価が￥11,000の場合</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券	1,000	その他有価証券評価差額金	1,000</div>
		<div>決算時の処理（時価評価）</div>
		...
		<div>借方科目	金額	貸方科目	金額</div>
		<div>その他有価証券	1,000	その他有価証券評価差額金	1,000</div>
		<div>その他有価証券の貸借対照表価額は時価の￥9,500となります。また、「その他有価証券評価差額金」は純資産のマイナスとなります。</div>
		<div>【参考】評価差額の処理</div>
		<div>その他有価証券は、事業遂行上の必要性からただちに売却することが困難である場合があります。例えば、業務提携などを目的として保有している場合、時価が上昇したからといってすぐに売却できるものではありません。</div>
		<div>そのため、売却することについて事業遂行上の制約がない売買目的有価証券のように、評価差額を当期の損益（財務活動の成果）として処理することは適切でないと考えられます。</div>
		<div>そこで、その他有価証券の評価差額は当期の損益とはせずに、純資産の部に直接計上する方法が採用されています。</div>
            <div></div>
            </article>
        </section>
	...
	<Title title="償却原価法とは"/>
        <section>
            <article>
           	<div>満期保有目的債券は原則として取得原価で評価します</div>
            	<div>ただし、債券を債券金額より低い価額又は高い価額で取得した場合において、取得原価と債券金額との差額の性格が金利の調整と認められるときは、償却原価法にもとづいて算定された価額をもって貸借対照表価額とします。</div>
		<div>償却原価法（定額法）とは、債券を債券金額より低い価額又は高い価額で取得した場合において、当該差額に相当する金額を取得日から満期日（償還日）に至るまで毎期均等額を貸借対照表価額に加減する方法をいいます。</div>
		<div>社債の約定利率が市場の平均利子率よりも低い場合、社債の発行会社は金利の調整という目的から、額面金額よりも低い価額で社債を発行する場合があります（これを割引発行といいます）。</div>
		<div>このような場合、社債の額面金額と取得原価との差額は利息としての性格を持つことになります。</div>
		<div>社債は額面金額で償還されるので、もし償却原価法を適用せずに帳簿価額が取得原価のままだとすると、満期日が属する期において、額面金額と取得原価との差額の全額が収益（有価証券利息）として計上されることになります。</div>
		<div>社債は額面金額で償還されるので、もし償却原価法を適用せずに帳簿価額が取得原価のままだとすると、満期日が属する期において、額面金額と取得原価との差額の全額が収益（有価証券利息）として計上されることになります。</div>
		<div>そこで適正な期間損益計算という観点から、額面金額と取得原価との差額を満期保有目的債券の保有期間に応じて毎期、収益（有価証券利息）として計上していこうというわけです。</div>
		
		<table border="1" cellspacing="0" class="journal">
		<caption class="question">決算日と利払日が同じケース</caption>
                <caption class="question">×1年4月1日に、満期保有目的でA社社債￥970,000（額面総額：￥1,000,000、満期日：×4年3月31日、券面利子率：6％、利払日：3月末および9月末）を現金で取得した。なお、取得原価と額面金額との差額はすべて金利の調整部分であると認められるため、償却原価法（定額法）を適用する。また、当社の会計期間は3月末を決算日とする1年間である。</caption>
                <caption>取得したとき（×1年4月1日）の仕訳</caption>
		<tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
                <tr>
                    <td>満期保有目的債券 970,000</td>
                    <td>現金 970,000</td>
                </tr>
            </table>

		<table border="1" cellspacing="0" class="journal">
                <caption>1回目の利払日（×1年9月30日）の仕訳</caption>
		<tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
		...
		<div>利息は額面金額に券面利子率を掛けて計算しますが、取得してから利払日までの期間は６か月（×1年4月1日～9月30日）なので月割で計算します。なお、受け取った利息は有価証券利息勘定（営業外収益）で処理します。</div>
		<div>1,000,000×6％×6か月/12か月</div>
		<div>2回目の利払日（×2年3月31日）の仕訳は、1回目の利払日の処理とまったく同じです。</div>

		<table border="1" cellspacing="0" class="journal">
                <caption>決算時（×2年3月31日）の仕訳</caption>
		<tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
                <tr>
                    <td>満期保有目的債券 10,000</td>
                    <td>有価証券利息 10,000</td>
                </tr>
            </table>
		<div>定額法とは取得原価と額面金額との差額に相当する金額を取得日から満期日（償還日）に至るまで毎期均等額を貸借対照表価額に加減する方法をいいます。</div>
		<div>”取得日”から満期日までの期間で償却するという点に注意してください。”発行日”から償却するのではありません。</div>
		<div>取得日（×1年4月1日）から満期日（×4年3月31日）までは3年（36か月）なので、この期間で取得原価￥970,000と額面金額￥1,000,000との差額￥30,000を月割計算により満期保有目的債券の帳簿価額に加算します。</div>
		<div>×1年度における保有期間は×1年4月1日～×2年3月31日の1年（12か月）なので、×1年度の償却額の計算と仕訳は次のようになります。</div>
		<div>×1年度の償却額：￥30,000×12か月/36か月＝￥10,000</div>
		<div>取得原価と額面金額の差額は金利の調整なので、加算した金額は有価証券利息として処理します。</div>
		<div>上の仕訳は×2年度以降の決算日でも全く同じ処理になります。なお、タイムテーブルを見てお分かりのとおり、満期日には簿価と額面金額が一致します。</div>

		<table border="1" cellspacing="0" class="journal">
			<caption>決算日と利払日が異なるケース</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
		...
		<div>次に決算日と利払日が異なるケースについて説明します。基本的な処理は先ほどと同じですが、有価証券利息の見越計上が必要になるという点にだけ気をつけてください。</div>

		
		<table border="1" cellspacing="0" class="journal">
			<caption>×1年1月1日に、満期保有目的でA社社債￥970,000（額面：￥1,000,000、満期日：×3年12月31日、券面利子率：6％、利払日：6月末および12月末）を現金で取得した。なお、取得原価と額面金額との差額はすべて金利の調整部分であると認められるため、償却原価法（定額法）を適用する。また、当社の会計期間は3月末を決算日とする1年間である。</caption>
			<caption>取得したとき（×1年1月1日）の仕訳</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
			...
			<table border="1" cellspacing="0" class="journal">
			<caption>取得してから1回目の決算日（×1年3月31日）の仕訳</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
			...
			<table border="1" cellspacing="0" class="journal">
			<caption>有価証券利息の見越計上</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
			<tr>
			    <td>未収有価証券利息 15,000</td>
			    <td>有価証券利息 15,000</td>
			</tr>
			</table>
			<div>決算日と利払日がずれているので、保有期間に係る有価証券利息の見越計上を行います。計算期間は満期保有目的債券の保有期間、すなわち取得日（×1年1月1日）から決算日（×1年3月31日）までの3か月間となります。</div>
		<div>￥1,000,000×6％×3か月/12か月＝￥15,000</div>
		<div>次に満期保有目的債券について償却原価法を適用します。</div>

		<table border="1" cellspacing="0" class="journal">
			<caption>取得日（×1年1月1日）から満期日（×3年12月31日）までは3年（36か月）なので、この期間で取得原価￥970,000と額面金額￥1,000,000との差額￥30,000を月割計算により満期保有目的債券の帳簿価額に加算します。</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
			<tr>
			    <td>満期保有目的債券 2,500</td>
			    <td>有価証券利息 2,500</td>
			</tr>
			</table>

			<div>なお、計算期間は見越計上の場合と同じく取得日から決算日までの3か月間です。</div>
			<div>￥30,000×3か月/36か月＝￥2,500</div>
		...
		<table border="1" cellspacing="0" class="journal">
			<caption>取得してから2回目の決算日（×2年3月31日）の仕訳</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
		...
		<div>決算時には有価証券利息の見越計上を行います。計算期間は直近の利払日の翌日（×2年1月1日）から決算日（×2年3月31日）までの3か月間です。</div>
		<div>￥1,000,000×6％×3か月/12か月＝￥15,000</div>
		<div>次に償却額の計上を行います。計算期間は×1年度の保有期間（×1年4月1日～×2年3月31日）の1年間（12か月）となります。</div>

		<table border="1" cellspacing="0" class="journal">
			<caption>償却原価法の適用</caption>
			<tr>
			    <th>借方（運用形態）</th>
			    <th>貸方（調達源泉）</th>
			</tr>
		...
		<div>次に償却額の計上を行います。計算期間は×1年度の保有期間（×1年4月1日～×2年3月31日）の1年間（12か月）となります。</div>
		<div>￥30,000×12か月/36か月＝￥10,000</div>
		<div>取得日から満期日までの簿価の動きは次のようになります。満期日には、×3年4/1から×3年12/31までの9か月間の償却額を計上します。</div>
        ...
        <section>
            <article>
            	<div>会計の流れ</div>
		<div>会計を行う最終目標は確定申告もしくは決算を行い、納税義務を果たすことにあります。</div>
		<div>そのため、１年間のお金の動きを「仕訳」という形式で記帳していくことが必要です。</div>
		...
		<div>XXXX　10,000</div>
		<div>XXXX　10,000</div>
		<div>（意味）実際に発生したこと＝結果</div>
		<div>（意味）発生した理由＝原因</div>


		<div>※XXXX</div>
		<div>表示金額の内容を示すものを勘定科目といい、XXXXの項目に入ります</div>

		<div>→お金の動きを「原因」と「結果」に分けて記録していくことを複式簿記といいます。</div>

		<div>■仕訳作成演習問題（緑が結果、紫が原因になります）</div>
		<div>（１）コンビニでボールペンを現金で１００円で購入した。</div>

		<div>発生したもの：コンビニでボールペンを１００円で購入した。</div>
		<div>発生した理由：現金で１００円で購入したため。</div>

		<div>と考えられるので、上記の文を分解すると</div>
		<div>コンビニでボールペンを現金で１００円で購入した。</div>
		<div>という読み取り方が可能です。</div>
		...
		<div>（２）三菱UFJ銀行口座に現金を100,000円預け入れた</div>
		<div>まずは文章を原因と結果に分解してみましょう。</div>

		<div>発生したもの：三菱UFJ銀行口座に100,000円が預け入れられたということ</div>
		<div>発生した理由：現金100,000円を預け入れたため</div>

		<div>と考えられるので、上記の文を分解すると</div>
		<div>三菱UFJ銀行口座に現金を100,000円預け入れた</div>
		<div>という読み取り方が可能です。</div>
		...
		<div>借方</div>
		<div>貸方</div>
		<div>三菱UFJ銀行　100,000</div>
		<div>現金　100,000</div>
		<div>となります。</div>


		<div>（３）土地を20,000,000円で現金で購入した</div>

		<div>まずは文章を原因と結果に分解してみましょう。</div>
		<div>発生したもの：土地を20,000,000円で購入した</div>
		<div>と考えられるので、上記の文を分解すると</div>
		<div>土地を20,000,000円で現金で購入した</div>
		<div>という読み取り方が可能です。</div>
		<div>よって作成される仕訳は</div>

		<div>借方</div>
		<div>貸方</div>
		<div>土地　20,000,000</div>
		<div>現金　20,000,000</div>

		<div>となります。</div>

		<div>以上の（１）（２）（３）の流れにて、「仕訳」を作成し、貸借対照表と損益計算書を完成させます</div>
		<div>企業会計</div>

		<div>財務会計（株主向けの報告を目的とした会計）</div>
		<div>企業会計</div>
		<div>管理会計（経営管理を目的とした会計）</div>

		<div>◎トライアングル体制</div>
		<div>日本の企業会計は3つの法律が交わって出来ており、それぞれ準拠する法律によって会計処理が変わる</div>

		<div>①商法・会社法</div>
		<div>→今まで勉強してきた会計は商法・会社法会計</div>
		...
		<div>負債</div>
		<div>純資産</div>
		<div>（意味）入手した財・サービス</div>
		<div>（意味）入手手段</div>

		<div>資産：自分が持っている売ったらお金になるもの（＝財・サービス）</div>
		<div>負債：売ったらお金になるものを他人から入手した場合</div>
		<div>純資産：売ったらお金になるものを自分で用意した場合</div>
		...
		<div>１年以内に現金化されるもの→流動資産</div>
		<div>他人にあげたら価値があるもの</div>
		<div>資産　１年以上かかって現金化されるもの→固定資産</div>
		<div>他人に上げても価値がないもの　→　繰延資産</div>		

		<div>※「流動」と「固定」について</div>
		<div>１年を基準に、財産が動くかどうかが基準となります</div>
		<div>１年以内に何らかの形で動きがある場合には「流動」と言い、１年を超えても動きがないものを会計上、「固定」と呼びます</div>

		<div>1年以内に返せる負債　→　流動負債</div>
		<div>負債</div>
		<div>1年以上返済に時間がかかる負債　→　固定負債</div>

		<div>事業に使うと決めた自分のお金</div>
		<div>純資産</div>
		<div>1年間の儲け</div>
		</article>
		</section>
	...
	<section>
		...
		<div>利益</div>
		<div>損失</div>
		<div>収益：サービス提供の対価として受け取ったお金</div>
		<div>費用：サービス提供のために使ったお金</div>

		<div>なお、収益と費用は一致しません。</div>
		<div>収益のほうが費用よりも多かった場合、差額を利益と呼びます</div>
		<div>対して、収益のほうが費用よりも少なかった場合、差額を損失と呼びます</div>
		<div>損益計算書の表示区分と勘定科目一覧</div>

		<div>3級ではT字型をした勘定式の損益計算書を用いていましたが、2級では以下のように各段階の利益を表示する報告式（区分式）の損益計算書が出題されます。</div>

		<div>Ⅰ．売上高</div>
		<div>主たる営業活動による収益。</div>
		<div>Ⅱ．売上原価</div>
		<div>販売した商品の原価。</div>
		<div>Ⅲ．販売費及び一般管理費</div>
		<div>販売活動及び一般管理活動によって発生した費用。</div>
		<div>Ⅳ．営業外収益</div>
		<div>主たる営業活動以外（資金調達や投資活動など）によって発生した収益。</div>
		<div>Ⅴ．営業外費用</div>
		<div>主たる営業活動以外（資金調達や投資活動など）によって発生した費用。</div>
		<div>Ⅵ．特別利益</div>
		<div>非経常的（臨時的）に発生する利益。</div>
		<div>Ⅶ．特別損失</div>
		<div>非経常的（臨時的）に発生する損失。</div>

		<div>売上総利益</div>
		<div>売上高から売上原価を差し引いて計算する。商品の販売による利益で、一般に”粗利益”や”粗利”と呼ばれるもの。</div>
		<div>営業利益</div>
		<div>売上総利益から販売費及び一般管理費を差し引いて計算する。企業が行う営業活動から得られる利益を表す。</div>
		<div>経常利益</div>
		<div>営業利益に営業外収益を加算し、営業外費用を差し引いて計算する。企業が経常的に獲得できる利益。</div>
		<div>税引前当期純利益</div>
		<div>経常利益に特別利益を加算し、特別損失を差し引いて計算する。一会計期間に発生したすべての収益と費用を考慮した場合における利益。</div>
		<div>当期純利益</div>
		<div>税引前当期純利益から法人税、住民税および事業税を差し引いて計算する。企業の最終的な利益。なお、一般に”税引後”当期純利益とは表示しない点に注意。</div>
            </article>
        </section>
		...
		<div></div>
		<div>（個人事業主の場合）</div>
		<div>事業開始日までにかかった費用を開業費という</div>
		<div>（法人の場合）</div>
		<div>会社設立までにかかった費用を創立費といい、会社設立から営業開始日までにかかった費用を開業費という</div>
		<div>ポイント</div>
		<div>①開業のために支出した費用は開業費になる</div>
		<div>（遡れる期間の上限なし）</div>
		<div>②一部、開業費に出来ない支払いもある</div>
		<div>ex.敷金、固定資産の購入</div>
		<div>③開業のために支出した費用は、開業後も収益を生み続けるという性質をもつ</div>
		<div>→費用収益対応の原則より、開業費は繰延資産として扱う</div>
		<div>→減価償却が必要（原則：均等償却、耐用年数：60ヶ月以内）</div>
		<div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            	<div>元入金</div>
		<div>事業を始めるにあたって事業用に使うと決めた自分のお金</div>
		<div>個人事業主は事業を始める前に「事業用のお金」と「プライベート用のお金」に分けて管理する必要があります</div>
		<div>開始残高の元入金＝元入金＋青色申告特別控除前の所得金額＋事業主借ー事業主貸</div>
            </article>
        </section>
        ...
        <section>
            <article>
		<div>勘定科目の振替</div>
		<div>ある勘定科目の残高を、別の勘定科目に移行すること</div>

		<div>例．立替金3,000円を交際費に振替える場合</div>
		...
		<div>→借方と貸方の立替金同士が相殺されるので、交際費のみ計上される</div>
		<div>振替が必要な代表的勘定科目（経過勘定科目）</div>

		<div>前払金/前払費用：商品やサービスの提供を受ける前に支払ったお金のこと</div>
		<div>前受金：商品やサービスの提供を受ける前に受け取ったお金のこと</div>
		<div>仮受金：金銭の受け取りはあったものの、内容がわからず一時的に処理するためのお金のこと</div>
		<div>仮払金：金銭の支払いはあったものの、内容がわからず一時的に処理するためのお金のこと</div>
            </article>
        </section>
        ...
        <section>
            <article>
		<div>クレジットカード口座の会計処理</div>
		<div>クレジットカードは後から銀行より引き落としされるので、「負債」として扱う勘定科目になります。そのため、利用すればするほど「貸方」に金額が計上され、返済があれば、負債の減少となり「借方」に金額が計上されます</div>
		<div>なお、クレジットカードの利用額の引き落としについては、銀行口座からクレジットカード口座へお金が移動したと考え、「口座振替」として処理いただく必要があるので注意して下さい。</div>

		<div>（クレジットカードの利用時）</div>
		<div>借方</div>
		<div>貸方</div>
		<div>購入したもの</div>
		<div>クレジットカード口座</div>

		<div>（クレジットカード利用料金の引き落とし時）</div>
		<div>借方</div>
		<div>貸方</div>
		<div>クレジットカード口座</div>
		<div>銀行口座</div>
        ...
        <section>
            <article>
            <div>借入金の会計処理</div>
		<div>借金は後に返済が発生することから、「負債」になり、原則はクレジットカードと同様の会計処理を行っていただければ問題ないです。</div>

		<div>＜借入金の分類＞</div>
		<div>1年以内に返せる借金の場合　→　短期借入金</div>

		<div>借入金</div>

		<div>1年を超えて返す借金の場合　→　長期借入金</div>

		<div>例．6ヶ月で返済が完了する融資を60,000円分うけ、現金で受け取った。</div>
		<div>ただし、1回の返済は10,000円とする。</div>

		<div>（融資を受けたとき）</div>
		<div>借方</div>
		<div>貸方</div>
		<div>現金　60,000</div>
		<div>短期借入金　60,000</div>


		<div>（借金の返済時）</div>
		<div>借方</div>
		<div>貸方</div>
		<div>短期借入金　10,000</div>
		<div>出金口座　10,000</div>


		<div>※返済時には、融資を行った対価として、たいていの場合利息が発生します。</div>
		<div>このときは、勘定科目「支払利息」を用いて、利息分の金額の計上を行います。</div>
		<div>借入金・貸付金とはいわゆる”借金”のことです。</div>
		<div>お金を借りた場合は借入金（かりいれきん）勘定で処理し、お金を貸した場合は貸付金（かしつけきん）勘定で処理をします。</div>

		<div>借入金勘定は将来お金を返さなければならないという義務なので負債となります。また、貸付金勘定は将来お金を返してもらえるという権利なので資産となります。</div>

		<div>お金を貸している側は借入期間に係る利息を受け取ることができます。これを受取利息勘定（収益）で処理します。</div>
            </article>
        </section>
        ...
        <section>
            <article>
		<div>返金・返品の会計処理</div>
		<div>→逆仕訳（反対仕訳）で処理を行います</div>

		<div>☆逆仕訳（反対仕訳）とは</div>
		<div>全く同じ勘定科目で貸借のみ逆にした仕訳を作成すること</div>

		<div>例．売上が10,000円現金で上がった。</div>
		<div>借方</div>
		<div>貸方</div>
		<div>現金　10,000</div>
		<div>売上高　10,000</div>
		...
		<div>その後、販売した商品の一部に欠陥があることが判明し、3,000円分を返金対応した。</div>
		<div>借方</div>
		<div>貸方</div>
		<div>売上高　3,000</div>
		<div>現金　3,000</div>
        ...
        <section>
            <article>
		<div>家事按分</div>
		<div>確定申告や決算は「事業用」のお金の収支が計上対象になる。</div>
		<div>→事業用とプライベート用の支払いを明確に分けられない取引が存在する</div>
		<div>ex.自宅兼事務所でかかった電気代</div>
		<div>→プライベート割合と事業用割合（按分割合）を算出して事業用割合分のみ経費として計上する</div>

		<div>例題</div>
		<div>自宅兼事務所で電気代が12,000円発生した。ただし、業務の時間は8時間とする。</div>
		<div>→業務時間から按分割合を求めると、1日は24時間であるから、</div>
		<div>プライベートで使う時間：業務で使う時間</div>
		<div>＝１６：８</div>
		<div>＝２：１</div>
		<div>になる。</div>
		<div>よって、12,000円のうち、16/24(=2/3)がプライベート利用分、8/24(=1/3)が事業用の経費であるとすると、仕訳は</div>
		...
		<div>棚卸とは</div>
		<div>期末日において、売れ残った商品の在庫の数量を数え、在庫の金額がどれだけあったかを計算すること</div>

		<div>商品の購入を行った場合、仕入高などの費用勘定科目で仕訳が計上されるが、売れ残りは未だ収益になっていない金額になるので、費用収益対応の原則より、費用としての計上は回避しなければいけない</div>
		<div>→年度末に棚卸を行い、一時的に費用から資産へと振替える仕訳を立てる</div>

		<div>例．1月1日に事業を行うため、商品を1,000,000円現金で購入した。</div>

		<div>借方</div>
		<div>貸方</div>
		<div>仕入高　1,000,000</div>
		<div>現金　1,000,000</div>

		<div>12月31日に売れ残りを調べたところ、50,000円分売れ残りが生じた。</div>

		<div>借方</div>
		<div>貸方</div>
		<div>商品　50,000</div>
		<div>仕入高　50,000</div>
		<div>→このまま仕入高で処理するとわかりやすいのですが、実際には仕入高の名前が変わります！正確には貸方は「期末商品棚卸高」という勘定科目になります。正体は仕入高です。</div>

		<div>翌1月1日に、再び費用として計上を行った。</div>
		<div>借方</div>
		<div>貸方</div>
		<div>仕入高　50,000</div>
		<div>商品　50,000</div>

		<div>→こちらもこのまま仕入高で処理するとわかりやすいのですが、実際には仕入高の名前が変わります！正確には借方は「期首商品棚卸高」という勘定科目になります。正体は仕入高です。</div>
		<div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>残高ズレ</div>
		<div>実際の口座残高とfreeeに登録した口座残高が何らかの原因でズレてしまう現象</div>
		<div>①現金</div>
		<div>②銀行口座</div>
		<div>③クレジットカード</div>
		<div>の3種類がある</div>
		→<div>原則、総勘定元帳（または現預金レポート）を使って対応する</div>

		<div>☆クレジットカード口座の残高ズレの対応方法</div>
		<div>総勘定元帳からクレジットカードの利用額≠クレジットカードの引き落とし額となっている登録月を探す</div>

		<div>数字の見方</div>
		<div>借方</div>
		<div>貸方</div>
		<div>クレジットカードの引き落とし額</div>
		<div>クレジットカードの利用額</div>


		<div>☆銀行口座の残高ズレ</div>
		<div>①お客様に銀行の通帳を持ってきてもらい、総勘定元帳の登録と通帳の入出金履歴が完全一致しているか確認する</div>
		<div>②タイムラインからアタリをつける</div>
		...
		<div>☆現金口座の残高ズレ</div>
		<div>現金のやり取りに関しては、電子的記録が残らないのでサポート出来る範囲にも限界がある。原則、お客様にこれまで保存していた証憑などを見てもらい、原因を確認してもらうほか、ヘルプページの現金残高ズレの「よくある原因集」を併せて見てもらい、原因を特定する。</div>

		<div>数字の見方</div>
		<div>借方</div>
		<div>貸方</div>
		<div>現金への入金額</div>
		<div>現金からの出金額（利用額）</div>

		<div>→どうしてもズレの原因がわからない場合</div>
		<div>個人事業主の場合、事業主勘定で調整する</div>

		<div>（実際よりも現金の残高が多い場合）</div>
		...
		<div>※法人の場合</div>
		<div>税務署に相談。それでもだめなら、雑収入、雑損失で差額を計上。</div>
            <div></div>
            </article>
        </section>
		...
		<div>ここで、収益≠益金、費用≠損益となるので、使う法律によって算出される利益が異なる</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>貯蔵品に関する一連の処理</div>
		<div>コピー用紙や文房具、プリンタ用のインクなどのように毎期経常的に購入して消費するような消耗品は、購入時にすべて費用処理するのが一般的です。</div>
		<div>しかし、郵便切手や収入印紙など換金性が高い資産は、財産管理や税務申告を目的として厳密な資産計上を行う必要があります。</div>
		<div>そこで、このようなものに関しては購入時には適切な費用勘定で処理し、決算において未使用額を資産（貯蔵品勘定）に振り替える処理を行います。</div>
		<div>先ほど説明したように、郵便切手や収入印紙などは使った分だけが当期の費用となり、使っていない分は資産（貯蔵品）として次期へ繰り越します。なお、この処理は決算整理仕訳として行います。</div>
		<div>決算時に郵便切手が￥820分残っていた。</div>
		<div>郵便切手の未使用額を通信費勘定から貯蔵品勘定へ振り替えます。</div>
		<div>翌期首には再振替仕訳（さいふりかえしわけ）を行います。</div>
		<div>収益や費用を適正に算定するため、期首において前期末の決算整理仕訳の逆仕訳を行う場合があります。これを再振替仕訳といいます。</div>
		<div></div>
		<div></div>
            <div></div>
            </article>
        ...
        <section>
            <article>
            	<div>割戻と割引～仕訳のやり方と表示方法～</div>
		<div>割戻（わりもどし）とは、一定の期間に多額もしくは多量の取引をした相手に対して行う代金の返戻額等をいいます。</div>
		<div>値引や返品は商品に何らかの欠陥や瑕疵などがある場合に行われるのに対して、割戻は取引先に対するサービス的な意味合いで行われます。</div>
		<div>割戻の処理方法は返品の場合と全く同です。すなわち、商品を販売した時や仕入れた時の逆仕訳をすればいいだけなので問題ないと思います。</div>
		<div></div>
		<div></div>
		<div></div>
		<div></div>
		...
		<table border="1" cellspacing="0" class="journal">
                <caption class="question">掛けで仕入れた（販売した）商品￥1,000,000について、この金額の5％の割戻を受けた（行なった）。</caption>
		<caption class="question">仕入側の仕訳</caption>
                <tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
		...
		<div>商品を仕入れたときの逆仕訳によって、割戻による返戻額を仕入および買掛金から控除します。</div>

		<table border="1" cellspacing="0" class="journal">
                <caption class="question">掛けで仕入れた（販売した）商品￥1,000,000について、この金額の5％の割戻を受けた（行なった）。</caption>
		<caption class="question">販売側の仕訳</caption>
                <tr>
                    <th>借方（運用形態）</th>
                    <th>貸方（調達源泉）</th>
                </tr>
		...
		<div>商品を販売したときの逆仕訳によって、割戻による返戻額を売上および売掛金から控除します。</div>
            <div></div>
            </article>
        </section>
	...
	<Title title="割引とは"/>
        <section>
            <article>
		<div>掛けで取引をした場合、現金取引の場合と比べて代金の決済日が遅れることから、その分の利息に相当する金額が代金に含まれていると考えることができます。</div>
		<div>したがって、予定された決済日よりも早期に決済された場合には、その利息に相当する部分を免除する（免除される）ことがあります。</div>
		<div>この免除した（された）金額は「売上割引」（「仕入割引」）として処理します。</div>
		<div>割引は利息に相当するものなので営業外損益として処理します。具体的には「仕入割引」は営業外収益、「売上割引」は営業外費用となります。</div>
		<div>返品や割戻のように「仕入」や「売上」等から控除するのではないということに注意してください。</div>
		<div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            	<div>株式の発行と剰余金の配当・処分</div>
		<div>株式の発行</div>
		<div>株式会社では資金調達などの目的で株式を発行することがあります。株式を購入した株主からの払込金額は、原則としてその全額を資本金とします。</div>
		<div>剰余金の配当・処分とは？</div>
		<div>株式会社の場合、会社の設立や営業のために必要な資金を出すのは株主なので、株式会社の実質的な所有者（オーナー）は株主ということになります。</div>
		<div>したがって、株式会社が経営活動を通じて獲得した利益をどのように使うのかといった事項は株主が株主総会において決定することとされています。</div>
		<div>具体的には当期純利益をいったん繰越利益剰余金勘定（純資産）へ振り替え、決算後3ヶ月以内に開催される株主総会において、株主がその使いみちを決めるという流れになっています。</div>
		<div>このように、株主総会において利益（剰余金）の使いみちを決定することを剰余金の処分といい、このうち株主への配当金の支払いのことを剰余金の配当といいます。</div>
		<div>剰余金の処分が決議された時に繰越利益剰余金勘定からそれぞれの科目へ振り替え、使い道が決まらなかったものは次期以降に繰り越されます。</div>
		<div>会社の設立に際して、株式100株を1株当たり￥1,000で発行し、払込金を当座預金とした。</div>
		<div>株主総会における繰越利益剰余金の配当・処分は次のとおりである。</div>
		<div>配当金：￥30,000　利益準備金：￥3,000</div>
		<div>不測の損害等に備えて、一定の額を会社内に留保しておく制度を準備金といいます。会社法では株主への配当を行った場合に、一定の額を利益準備金（純資産）として積み立てることを要求しています。</div>
		<div>個人事業主の場合、獲得した利益は個人事業主のものなのでそれを自由に使っても法律的には問題ありません。しかし、株式会社の経営者が勝手に会社のお金を使うと法律的な問題が生じます。</div>
		<div></div>
		<div></div>
		<div></div>
		</article>
        ...
        <section>
            <article>
            <div>【消費税】税抜方式による仕訳のやり方</div>
		<div>物品やサービスの消費に対して課される税金のことを消費税といいます</div>

		<div>仕入先には商品代金のほかに消費税を支払い、販売先からは商品代金のほかに消費税を受け取ります。当社は仕入先へ支払った消費税と販売先から受け取った消費税との差額を納付します（または還付を受けます）。</div>

		<div>税抜方式とは、仕入等に係る消費税額（支払った消費税）を仮払消費税勘定（資産）で、また売上等に係る消費税額（受け取った消費税）を仮受消費税勘定（負債）で処理し、決算時に両者を相殺して、その差額を納付する（または還付を受ける）という方法です。</div>

		<div>商品￥88,000（うち消費税額￥8,000）を掛けで仕入れた。</div>
		<div>税抜方式では「仕入」の金額に消費税額を含めずに、仮払消費税勘定（資産）を使って区分します。</div>

		<div>商品を￥110,000（うち消費税額￥10,000）で売り上げ、代金は掛けとした。</div>
		<div>税抜方式では「売上」の金額に消費税額を含めずに、仮受消費税勘定（負債）を使って区分します。</div>

		<div>例題では支払った消費税（仮払消費税）よりも受け取った消費税（仮受消費税）の方が大きいので、両者の差額を後で納付することになります。そこで決算において仮払消費税と仮受消費税とを相殺し、その差額を未払消費税勘定（負債）に振り替えます。</div>

		<div>還付を受ける場合</div>
		<div>還付を受ける場合（「仮受消費税＜仮払消費税」のケース）では、その差額を未収還付消費税勘定（資産）に振り替えます。</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>租税公課と法人税、住民税及び事業税</div>

		<div>税金のうち、固定資産税、自動車税、印紙税（収入印紙）などは租税公課（そぜいこうか）勘定で処理をします。</div>

		<div>郵便局で切手￥100とハガキ￥200、収入印紙￥500を現金で購入した。</div>
		<div>収入印紙は印紙税という税金を納付するためのものですが、これも固定資産税や自動車税と同様に租税公課勘定で処理します。ちなみに、切手やハガキは通信費勘定（費用）で処理します。</div>

		<div>法人税、住民税及び事業税とは？</div>
		<div>法人税：会社など法人の所得金額（もうけ）に対して課される税金。</div>
		<div>住民税：道府県民税（道府県が個人及び法人に課税するもの）と市町村民税（市町村が個人及び法人に課税するもの）を合わせたもの。</div>
		<div>事業税：法人や個人が行う事業に対して課される税金。</div>

		<div>法人税の申告および納付は、原則として決算期末の翌日から2月以内に行うこととされています。</div>
		<div>ただし、事業年度が6ヶ月を超える法人は、事業年度を開始した月から6月を経過した日より2月以内に、当期に見込まれる税額の半分に相当する金額をあらかじめ中間申告し、前もって納付しなければなりません。これを中間納付制度といいます。</div>

		<div>法人税で中間申告をする必要がある場合は、住民税及び事業税でも中間申告をしなければなりません。</div>

		<div>中間納付時の仕訳</div>
		<div>当期の法人税、住民税及び事業税として￥20,000を現金で中間納付した。</div>

		<div>中間納付額はあくまでも概算額に過ぎないので、これをいったん仮払法人税等（資産）という勘定科目で処理しておきます。</div>

		<div>決算にあたり、当期純利益に対する法人税、住民税及び事業税として￥50,000を計上する。</div>
		<div>法人税等は法人税、住民税及び事業税勘定で処理をします。ただし、法人税等を実際に納付するのは後日となるため、この時点では貸方を未払法人税等勘定（負債）としておきます。</div>
		<div>また、すでに中間納付を行っている場合は中間納付時に計上した仮払法人税等をすべて取り崩します。</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>棚卸減耗損と商品評価損～ボックス図の書き方と仕訳・計算・表示の方法～</div>

		<div>何らかの原因（盗難や紛失など）で、期末商品の実際の数量（実地棚卸数量）が帳簿上の数量（帳簿棚卸数量）を下回る場合があります。</div>
		<div>このような場合、実地棚卸数量と帳簿棚卸数量との差額は棚卸減耗損（たなおろしげんもうそん）として処理します。</div>

		<div>商品評価損とは？</div>
		<div>商品によっては時間の経過や陳腐化などによってその価値が下がってしまうものがあります。</div>

		<div>商品を購入した時の原価よりも決算時点における時価（正味売却価額）の方が低い場合、商品の帳簿価額を時価まで切り下げる（時価に評価替えする）処理を行います。</div>
		<div>このときの、商品の原価と時価（正味売却価額）の差額は商品評価損として処理します。</div>

		<div>正味売却価額とは、売価から商品の販売にかかるコスト（アフターコスト）を差し引いたものをいいます。</div>
		<div>一言で時価といっても、どの金額をもって時価とするのかということにはいろいろな考え方がありますが、一般に商品などの棚卸資産の場合には正味売却価額をもって時価とします。したがって、試験では特に指示がない限り「時価＝正味売却価額」と考えてもらえば大丈夫です。</div>

		<div>なお、商品を正味売却価額で評価するのは正味売却価額が原価を下回っている場合のみです。</div>
		<div>それ以外のケース（原価≦正味売却価額）では時価で評価せず原価のままとします</div>

		<div>棚卸減耗損と商品評価損の表示方法</div>
		<div>棚卸減耗損の表示方法</div>
		<div>棚卸減耗損は損益計算書上、原則として売上原価の内訳科目または販売費および一般管理費とします（問題に指示がある場合はその指示に従ってください）。</div>

		<div>売上原価の内訳科目とする場合、棚卸減耗損は売上原価に加算されるので、次のように仕入勘定へ振り替える仕訳を行います（販売費及び一般管理費とする場合は、以下の仕訳は必要ありません）。</div>

		<div>売上原価を売上原価勘定で計算する場合は、借方を「売上原価」とします。</div>

		<div>商品評価損の表示方法</div>
		<div>商品評価損は損益計算書上、原則として売上原価の内訳科目とします。したがって、商品評価損は原則として売上原価に加算されることになるので、次のように仕入勘定へ振り替える仕訳を行います。</div>

		<div>期末商品の評価とP/L・B/Sとの関係</div>

		<div>棚卸減耗損と商品評価損のボックス図</div>
		<div>前回学習したように棚卸減耗損と商品評価損は繰越商品から控除するので、貸借対照表における「商品」の金額は棚卸減耗損と商品評価損を控除した後の金額であり、それは「＠時価×実地棚卸数量」で計算されたものとなります。</div>

		<div>一方、損益計算書における「期末商品棚卸高」の金額は棚卸減耗損と商品評価損を控除する前の金額（帳簿棚卸高）であり、「＠原価×帳簿棚卸数量」で計算されたものです。</div>

		<div>つまり棚卸減耗損や商品評価損がある場合には、損益計算書の「期末商品棚卸高」と貸借対照表の「商品」の金額が異なるということになるわけです。</div>

		<div>売上原価は本来、当期に販売した商品の原価を意味します。</div>
		<div>棚卸減耗等がない場合、「期首商品棚卸高＋当期商品仕入高ー期末商品棚卸高」で計算された金額は、まさしく当期に販売した商品の原価を表します。</div>

		<div>棚卸減耗等がある場合、もしこれらを控除した金額（実地棚卸高）にもとづいて売上原価を計算すると、売上原価に棚卸減耗等が含まれてしまいます。</div>

		<div>そこで、損益計算書においては売上原価を帳簿棚卸高にもとづいて計算することで、いったん当期に販売した商品の原価を表示し、そこに棚卸減耗損等を加算するという形で表示します。</div>
        ...
        <section>
            <article>
		<div>売上の計上基準</div>
		<div>出荷基準（発送基準）：商品を出荷（発送）したときに売上を計上する基準。</div>
		<div>引渡基準（納品基準）：得意先に商品を引き渡した（納品した）ときに売上を計上する基準。</div>
		<div>検収基準：納品した商品の数量や品質などを相手方が確認し（これを検収といいます）、その連絡を受けた時に売上を計上する基準。</div>
		<div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>売上原価対立法</div>
		<div>売上原価対立法とは、商品を仕入れたときは商品勘定の借方に原価で記入し、商品を販売したときは商品勘定の貸方に原価で記入するとともに、売上原価勘定の借方に記入する方法をいいます。</div>

		<div>商品￥1,200を掛けで仕入れた。</div>
		<div>商品を仕入れたときは商品勘定の借方に原価で記入します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>商品	1,200	買掛金	1,200</div>

		<div>商品（原価￥1,100）を￥1,500で販売し、代金は掛けとした。</div>
		<div>商品を販売したときは商品勘定の貸方に原価で記入するとともに、売上原価勘定の借方に記入します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>売掛金	1,500	売上	1,500</div>
		<div>売上原価	1,100	商品	1,100</div>

		<div>決算を迎えた。期首商品棚卸高は￥150、期末商品棚卸高は￥250である</div>
		<div>売上原価対立法では、商品を販売したときにその原価を商品勘定から売上原価勘定へ振り替えています。</div>
		<div>そのため、三分法のように決算において売上原価を算定するための仕訳は必要ありません。</div>
		<div></div>
            </article>
        </section>
        ...
        <section>
            <article>
		<div>【役務収益と役務原価】サービス業の処理</div>
		<div>これまでは具体的な形の有るモノを売買する商品売買業について学習してきましたが、世の中には形のない「サービス」を提供することで収益を得る業種もあります。このような業種の場合、どのように仕訳をすればいいのでしょうか？</div>

		<div>物品の販売ではなく、サービス（役務（えきむ））を提供することで収益を得る業種のことをサービス業といいます。サービス業には、教育、宅配、運送・輸送、修理・補修、理容、クリーニングなど様々な業態があります。</div>

		<div>代金を前受けしたときの仕訳</div>
		<div>例題1</div>
		<div>学習塾を経営する当社では、来月開講予定の講座（受講期間1年）の受講料￥100,000を現金で受け取った。</div>
		<div>3級で学習したように売上を計上するためには、原則として「代金の授受」と「商品の引渡又はサービス（役務）の提供」の2つの条件を満たす必要があります。したがって、サービスを提供する前に代金を前受けしただけでは収益を計上することはできません。</div>

		<div>そこで、受け取った金額を「前受金」として処理します。</div>

		<div>費用を支払ったときの処理</div>
		<div>例題2</div>
		<div>来月開講予定の講座に先立ち、教材の作成費用として￥15,000を現金で支払った。なお、この教材作成費用は仕掛品勘定に計上する。</div>
		<div>費用は収益を獲得するための”犠牲”となるものです。そのため、会計では収益が計上されたときに、その”犠牲”となった費用を対応させて計上すべきというルールになっています（これを「費用収益対応の原則」といいます）。</div>

		<div>この原則からいうと、サービスの提供による収益が計上されていない段階で費用だけを計上することはできません。そこで、支払った金額を仕掛品勘定（資産）で処理します。</div>

		<div>決算日現在、講座の8割が終了している。</div>
		<div>決算においては、当期にサービスの提供を終えた部分に相当する金額のみを収益（役務収益）および費用（役務原価）として計上します。</div>
		<div>当期にサービスの提供を行った部分に相当する金額を「前受金」から役務収益勘定へ振り替えます。また、役務収益に対応する費用を「仕掛品」から役務原価勘定へ振り替えます。</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>債務の保証および債権の譲渡</div>

		<div>債務の保証とは？</div>
		<div>主たる債務者が債務の返済をできない場合に、その債務の返済を引き受けることを債務の保証といいます。</div>

		<div>例えば当社がA社の借入金などの債務を保証していた場合、もしA社が債務の返済をできなくなると、当社が代わってその債務を返済しなければなりません。</div>

		<div>このように「現在ではいまだ現実の債務ではないが、将来一定の事実が発生した場合に現実の債務となるもの」を偶発債務といいます。</div>

		<div>債務の保証は簿記上の取引ではないため債務の保証自体に関する仕訳は必要ありませんが、偶発債務が発生した場合、それを忘れないようにするために帳簿上で備忘記録をしておきます。</div>

		<div>この備忘記録は保証債務および保証債務見返（ほしょうさいむみかえり）という対照勘定を使って処理します。</div>
		<div>「保証債務」は”債務”と付くので負債の貸方。借方はその相手科目なので”見返”が付くと覚えてください。</div>

		<div>【参考】対照勘定</div>
		<div>対照勘定とは借方項目と貸方項目の2つが1セットで対になっているような勘定科目で、主に備忘記録をする際などに用いられる勘定です。対照勘定は、あくまでも帳簿上で備忘記録をするためのものに過ぎないので貸借対照表などに記載されることはありません。</div>

		<div>債務保証の契約をしたときの仕訳</div>
		<div>例題1</div>
		<div>当社は、A社の債務￥100,000について保証人となった。</div>
		<div>債務保証の契約をしたときには、債務の保証に係る偶発債務を対照勘定を使って備忘記録します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>保証債務見返	100,000	保証債務	100,000</div>
		<div> ケース1：主たる債務者が返済したときの仕訳</div>
		<div>例題2-1</div>
		<div>A社は、当社が保証人になっていた債務￥100,000を無事返済した。</div>
		<div>主たる債務者（A社）が無事債務を返済した場合には、偶発債務が消滅するので備忘記録（対照勘定）を消去します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>保証債務	100,000	保証債務見返	100,000</div>

		<div>主たる債務者が返済不能になった場合の仕訳</div>
		<div>例題2-2</div>
		<div>当社が保証人になっていた債務についてA社が返済できなくなったため、当社が代わって現金で返済した。</div>
		<div>当社がA社に代わって債務を返済した場合、のちにA社に対してその代金を請求することができるので、そのA社に対する債権を未収入金などで処理します。 同時に、偶発債務の消滅に伴って備忘記録（対照勘定）を消去します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>未収入金	100,000	現金	100,000</div>
		<div>保証債務	100,000	保証債務見返	100,000</div>

		<div>買掛金などの支払いのために譲渡した場合</div>
		<div>例題3</div>
		<div>得意先A社に対する売掛金￥1,000を、仕入先B社に対する買掛金の支払いのため、同社にこれを譲渡した。</div>

		<div>売掛金などの売上債権は、買掛金などの債務の支払いのために債務者の承諾を得た上で第三者へ譲渡することができます。この場合、これらの債権・債務を相殺させる仕訳を行います。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>買掛金	1,000	売掛金	1,000</div>

		<div>売掛金を売却した場合</div>
		<div>例題4</div>
		<div>売掛金￥3,000を￥2,800で売却し、代金は当座預金口座に振り込まれた。</div>
		<div>債権の現金化やリスクヘッジなどの目的のために、売掛金などの売上債権をファクタリング会社（債権の買取りや回収などを行う会社）などへ売却する場合があります。</div>

		<div>このとき、債権金額と売却金額との差額は債権売却損勘定（営業外費用）で処理します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>当座預金	2,800	売掛金	3,000</div>
		<div>債権売却損	200</div>	

		<div>電子記録債権の譲渡</div>
		<div>電子記録債権は通常の手形の裏書譲渡や割引と同様に、譲渡記録を行うことで第3者に譲渡や売却をすることができます。</div>

		<div>実際には、これらの取引はそれぞれの取引銀行を通じて行われます。</div>

		<div>電子記録債権を譲渡した場合の仕訳</div>
		<div>例題5</div>
		<div>A社はB社に対する買掛金￥5,000の決済のため、所有する電子記録債権￥5,000を譲渡するために譲渡記録を行った。</div>
		<div> A社（譲渡人）の仕訳</div>
		<div>電子記録債権を譲渡した場合は「電子記録債権」（資産）を減少させます。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>買掛金	5,000	電子記録債権	5,000</div>

		<div>B社（譲受人）の仕訳</div>
		<div>電子記録債権を譲渡された場合は「電子記録債権」（資産）で処理します。</div>

		<div>借方科目	金額	貸方科目	金額</div>
		<div>電子記録債権	5,000	売掛金	5,000</div>
		<div>電子記録債権を割引いた（売却した）場合の仕訳</div>
		<div>例題6
		<div>A社は電子記録債権￥4,000を取引銀行で割り引き、割引料￥100が差し引かれた残額が普通預金口座に振り込まれた。</div>
		<div>電子記録債権を割り引いたり売却をした場合、電子記録債権の帳簿価額と譲渡金額との差額を電子記録債権売却損勘定（営業外費用）で処理します。</div>
		</div>
		<div>借方科目	金額	貸方科目	金額</div>
		<div>普通預金	3,900	電子記録債権	4,000</div>
		<div>電子記録債権売却損	100		</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>商品を仕入れたときは原価で仕入勘定の借方に記入し、販売したときは売価で売上勘定の貸方に記入します。また、決算時に売れ残っている商品の原価を繰越商品（くりこししょうひん）勘定へ振り替えます。このような記帳方法を三分法（さんぶんぽう）といいます。</div>

		<div>商品売買の処理に関して、仕入勘定、売上勘定、繰越商品勘定の3つに分けて記帳するので「三分法」というわけです。</div>
		<div>商品￥1,000を仕入れ、代金は現金で支払った。なお、記帳方法は三分法によること。</div>
		<div>商品を￥900で販売し、代金は現金で受け取った。なお、記帳方法は三分法によること。</div>
		<div>決算時には、売れ残っている商品（在庫品）の原価を繰越商品勘定へ振り替える処理をします。</div>

		<div>売上原価（うりあげげんか）とは外部に販売した商品の原価のことをいいます。</div>
		<div>期首に倉庫の中には商品が2個あったとします。ちなみに、期首に倉庫や店頭に残っていた商品の原価を期首商品棚卸高（きしゅしょうひんたなおろしだか）といいます。これは前期からの商品の繰越額を意味します。</div>
		<div>当期に商品を3個仕入れました。なお、当期に仕入れた商品の原価を当期商品仕入高（とうきしょうひんしいれだか）といい、これは決算整理前残高試算表の仕入勘定の金額を意味します。</div>
		<div>当期に商品を？個販売して払い出しました。この販売した商品の原価のことを売上原価といいます。</div>

		<div>期末には倉庫に商品が1個残っていました。期末に倉庫や店頭に残っている商品の原価を期末商品棚卸高（きまつしょうひんたなおろしだか）といい、次期へ繰り越される商品の金額を意味します。</div>
		<div>さて、当期に払い出した商品は何個でしょうか？</div>
		<div>考えてみてください。もうおわかりですね？</div>
		<div>そう、正解は4個です。</div>
		<div>この4個という数字は次のように計算したと思いますが、売上原価の計算方法は今まさにあなたが頭の中で行った計算なのです。</div>
		<div>売上原価＝期首商品棚卸高＋当期商品仕入高－期末商品棚卸高</div>

		<div>なお、商品の繰越額（期首商品棚卸高・期末商品棚卸高）は繰越商品（くりこししょうひん）勘定で処理をします。</div>

		<div>期首商品棚卸高が￥200、当期商品仕入高が￥900、期末商品棚卸高が￥150のとき、売上原価を計算するための仕訳を示しなさい。なお、売上原価は仕入勘定で計算する。</div>



		<div>商品を仕入れたときは原価で商品勘定の借方に記入し、販売したときは原価を商品勘定の貸方に記入するとともに、利益を商品売買益勘定の貸方に記入する方法を分記法（ぶんきほう）といいます。</div>

		<div>商品売買の処理に関して、商品の売価を原価（商品勘定）と利益（商品売買益勘定）に分けて記帳するので「分記法」というわけです。</div>

		<div>商品￥800を仕入れ、代金は現金で支払った。なお、記帳方法は分記法によること。</div>
		<div>分記法では、仕入れた商品の原価を商品勘定の借方に記入します。</div>

		<div>商品（原価￥800）を￥900で販売し、代金は現金で受け取った。なお、記帳方法は分記法によること。</div>
		<div>分記法では、販売した商品の原価を商品勘定の貸方に記入するとともに、利益を商品売買益勘定の貸方に記入します。</div>

		<div>ただ分記法では販売に際して、その商品の原価が分からないと処理できないというデメリットがあります。大量の商品を扱う会社では販売の都度、その商品の原価をいちいち調べるのは非常に手間がかかります。</div>

		<div>このような理由から一般の会社では多くの場合、三分法が採用されています。試験においても重要性が高いのは三分法で、指示がない限り三分法による記帳が前提となっています。</div>

		<div>取引の代金を現金で精算せず、後日まとめて精算する取引のことを掛取引（かけとりひき）といいます。</div>

		<div>毎日大量に取引が行われる場合、そのつど個別に現金や小切手で精算していたのでは事務処理が大変になります。その場合、一定期間（1ヶ月など）の取引金額をまとめて精算するほうが効率的なのです。</div>

		<div>商品を掛けで仕入れた場合、将来代金を支払う義務が発生します。簿記上、このような義務は負債として扱います。</div>

		<div>商品を掛けで販売した場合、将来代金を受け取る権利が発生します。簿記上、このような権利は資産として扱います。</div>

		<div>返品（へんぴん）とは品違いなどの理由によって商品を返す（または返ってくる）ことをいいます。</div>

		<div>返品の処理は全く難しくありません。なぜなら、商品を仕入れたとき、または販売したときの逆仕訳をすればいいだけだからです。</div>

		<div>仕入戻しとは、仕入れた商品をそのまま相手に返すことです。</div>
		<div>品違いのため、掛けで仕入れた商品のうち￥80を返品した。</div>

		<div>売上戻りとは、販売した商品がそのまま返ってくることです。</div>
		<div>品違いのため、掛けで販売した商品のうち￥100（原価￥80）の返品を受けた。</div>

		<div>商品などを売買するときには様々な費用が付随して発生しますが、このような費用を付随費用（ふずいひよう）といいます。具体的なものとしては、運賃、保険料、手数料、荷役費（バイト代）、保管料、関税などがあります。</div>

		<div>付随費用は当社が負担する場合と相手方が負担する場合があり、それぞれ処理の方法が異なります。</div>

		<div>当社負担の付随費用の処理</div>

		<div>仕入諸掛の仕訳</div>
		<div>付随費用のうち、引取運賃など商品を仕入れるときに発生するものを仕入諸掛（しいれしょがかり）といいます。当社負担の仕入諸掛はすべて商品の購入原価（「仕入」の金額）に含めます。</div>

		<div>商品￥500を掛けで仕入れ、この引取運賃￥100は現金で支払った。なお、付随費用については当社が負担する契約となっている。</div>

		<div>この付随費用は商品の仕入に際して不可避的なものです。この付随費用を支払わないと商品をもらえないので、商品の代金と区別せずに一体として処理します。</div>

		<div>販売諸掛の仕訳</div>
		<div>付随費用のうち、発送費など商品を販売するときに発生するものを販売諸掛（はんばいしょがかり）といいます。</div>

		<div>先方負担の付随費用の処理</div>
		<div>相手方が負担する契約となっている付随費用を当社が立て替えて支払った場合、①立替金（たてかえきん）勘定を使って処理する方法と②立替金勘定を使わずに処理する方法があります。</div>

		<div>立替金勘定は、立て替えたお金を将来相手から支払ってもらえるという権利を表します。簿記ではこのような権利を資産として扱います。</div>

		<div>商品￥500を掛けで仕入れ、これに付随して発生した費用￥100は現金で支払った。なお、付随費用については相手方が負担する契約となっている。</div>

		<div>先方負担の付随費用を当社が立て替えて支払ったことになるので、これを立替金勘定で処理します。</div>
		<div>立替金勘定を使わずに処理する方法では、立て替えた金額を買掛金から差し引きます</div>
            <div></div>
            </article>
        </section>
        ...
        <section>
            <article>
            <div>差入保証金（さしいれほしょうきん）とは、取引や賃貸借契約に際して、契約の履行を担保するために差し入れる保証金や敷金等をいいます。</div>
		<div>差し入れた保証金や敷金は原則として契約終了時に返還されるます。つまり、一時的に預けているだけと考えられるので差入保証金は資産（将来返してもらえる権利）となります。</div>
		<div>営業に使用する目的で、店舗を1か月あたり￥1,000で賃借する契約を結んだ。この契約にあたり、敷金（家賃の2か月分）および不動産会社への仲介手数料（家賃の1か月分）を小切手を振り出して支払った。</div>
		<div>敷金は「差入保証金」（資産）、仲介手数料は「支払手数料」（費用）で処理します。</div>
            <div></div>
            </article>
        </section>
